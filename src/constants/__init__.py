...
DATA_TRANSFORMATION_TEST_SIZE = float(os.getenv('test_size',0.3))


MODEL_TRAINER_BASE_ACCURACY = float(os.getenv('base_accuracy',0.6))
...
MODEL_EVALUATION_THRESHOLD_VALUE = float(os.getenv('threshold_value',0.2))
MODEL_EVALUATION_METRIC_NAMES = ['f1',]



MODEL_PUSHER_SAVED_MODEL_DIRS =  os.getenv('model_pusher', 'saved_models') 
MODEL_PUSHER_DIR = "model_pusher"
MODEL_PUSHER_MODEL_NAME = MODEL_TRAINER_MODEL_NAME

MODEL_SAVED_DIR = os.getenv('model_saved', 'saved_models')
