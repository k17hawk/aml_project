...
MODEL_EVALUATION_THRESHOLD_VALUE = os.getenv('MODEL_EVALUATION_THRESHOLD_VALUE')
MODEL_EVALUATION_METRIC_NAMES = ['f1',]
MODEL_SAVED_DIR=os.getenv('MODEL_SAVED_DIR','saved_models')


MODEL_PUSHER_SAVED_MODEL_DIRS = os.getenv('MODEL_PUSHER_SAVED_MODEL_DIRS','saved_models')
