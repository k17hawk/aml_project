...
#     """Class to manage Spark session creation and configuration"""
    
#     def __init__(self, app_name: str = "MySparkApp"):
#         self.app_name = app_name
#         self.spark = None
    
#     def create_session(self) -> SparkSession:
#         """Create and configure a Spark session with predefined settings"""
...
#             print("Spark session stopped")
    ...
    # Session automatically stopped when exiting the context
